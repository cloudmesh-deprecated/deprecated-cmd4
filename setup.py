...
import os
import sys
from cloudmesh_cmd4.version import __version__
import platform
...
setup(
    version=__version__,
    name="cloudmesh_cmd4",
    description="cloudmesh_cmd4 - command shell"
                "client and shell",
    long_description=read('README.rst'),
    license="Apache License, Version 2.0",
    author="Gregor von Laszewski",
    author_email="laszewski@gmail.com",
    url="https://github.com/cloudmesh/cloudmesh_cmd4",
    classifiers=[
    ...
    entry_points={
        'console_scripts': [
            'cmd4 = cloudmesh_cmd4.cmd4.cmd4:main',
        ],
    },
    # tests_require=['tox'],
    # dependency_links = []
